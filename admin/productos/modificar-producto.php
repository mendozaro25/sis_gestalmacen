                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <form action="../actions/producto/update.php" method="post">
                                        <?php  while ($row = $datosPro->fetch_assoc()) { ?>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-2">
                                                    <input class="form-control" readonly="readonly" name="id" type="hidden" value="<?php echo $row['idProducto'];?>"/>
                                                </div>
                                                <div class="col-lg-12">                                                    
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">                                                    
                                                    ...
                                                    <select class="form-control" name="categoria">
                                                        <option value=" <?php echo $row['idCategoria'];?> " selected hidden><?php echo $row['nombreCategoria'];?></option>                                                                                                           
                                                        <?php  while ($rowCat = $datosCat->fetch_assoc()) {?>
                                                            <option value="<?php echo $rowCat['idCategoria'];?>"><?php echo $rowCat['nombreCategoria'];?></option>                                                                                                           
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                <div class="col-lg-6">                                                    
                                                    ...
                                                    <select class="form-control" name="marca">
                                                        <option value=" <?php echo $row['idMarca'];?> " selected hidden><?php echo $row['nombreMarca'];?></option>
                                                        <?php  while ($rowMar = $datosMar->fetch_assoc()) { ?>
                                                            <option value="<?php echo $rowMar['idMarca'];?>"><?php echo $rowMar['nombreMarca'];?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>                                    
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">                                                    
                                                    ...
                                                    <input type="text" class="form-control" name="stockmin" value="<?php echo $row['stockMin'];?>"/>
                                                </div>  
                                                <div class="col-lg-4">    
                                                    <label>Descripción</label>
                                                    <div>
                                                        <input class="form-control" name="descripcion" value="<?php echo $row['descripcion'];?>"></input>
                                                    </div>
                                                </div>                                  
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">                                                    
                                                    ...
                                                    <select class="form-control" name="estado">
                                                        <option value="<?php echo $row['estadoProducto'];?>" selected hidden>
                                                        <?php
                                        ...
                                        <div class="form-group mb-0">
                                            <div>
                                                ...
                                                <button type="submit" class="btn btn-primary waves-effect waves-light">
                                                    <a style="color:white;" href="./lista-producto">Volver</a>
                                                </button>
                                            </div>
                                        </div>
                                    </form>
