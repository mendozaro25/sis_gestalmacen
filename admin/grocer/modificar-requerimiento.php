        ...
        <section>
                ...
                <div class="sidebar-left-info">
                    ...
                    <ul class="side-navigation">
                        ...
                        <li class="menu-list nav-active active"><a href=""><i class="mdi mdi-codepen"></i> <span>Requerimientos</span></a>
                            <ul class="child-list">
                                <li class="active"><a href="nuevo-requerimiento"> Registrar Requerimientos</a></li>
            ...
            <div class="body-content">
                ...
                <div class="container-fluid">                                        
                    <form onsubmit="return confirm('¿Realmente deseas aceptar el requerimiento?');" action="update.php" method="post">
                                        ...
                                        <div class="form-group">                                            
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input disabled type="date" class="form-control" disabled value="<?php echo $rowdetalle['fecha'];?>">
                                                </div>
                                            </div>
                                        </div>
...
<form onsubmit="return confirm('Este requerimiento sera eliminado. ¿Aceptar?');" action="decline.php" method="post">
    <!-- Modal -->
    <?php
        //Sesion
        include("session/grocer-session.php");
