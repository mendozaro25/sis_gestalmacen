                    ...
                    <ul class="side-navigation">
                        ...
                        <li class="menu-list nav-active active"><a href=""><i class="mdi mdi-codepen"></i> <span>Requerimientos</span></a>
                            <ul class="child-list">
                                ...
                                <li class="active"><a href="../requerimientos/lista-requerimiento"> Lista de Requerimientos</a></li>
                            </ul>
                        </li> 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            ...
                                                            <a type="button" onclick="return confirmDelete();" class="tabledit-delete-button btn btn-sm btn-danger" href="../actions/requerimiento/delete.php?idRequerimiento=<?php echo $rowReq['idRequerimiento'];?>">
