        ...
        <section>
            ...
            <div class="body-content">
                ...
                <div class="container-fluid">                                        
                    <form onsubmit="return validMe()" action="../actions/requerimiento/insert.php" method="post">
                        <div class="page-head">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <label>Usuario</label>
                                                    <select class="js-users form-control" name="usuario" required>    
                                                        <option selected disabled hidden>- Seleccionar -</option>                                                                                                             
                                                        <?php  while ($rowUsu = $datosUsu->fetch_assoc()) {?>
                                                            <option value="<?php echo $rowUsu['idUsuario'];?>"><?php echo $rowUsu['nombreArea'].' - '.$rowUsu['nombres'].' '.$rowUsu['apellidos']; ?></option>                                                                                                           
                                                        <?php }?>
                                                    </select>
                                                </div>
                                                <div class="col-lg-6">
