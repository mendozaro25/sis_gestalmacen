        ...
        <section>
            ...
            <div class="body-content">
                ...
                <div class="container-fluid">
                    <form id="formMov" onsubmit="return validMe()" action="../actions/movimientoAlm/insert.php" method="post" enctype="multipart/form-data">
                        <div class="page-head">
            ...
            switch (op) {
                case "eRequerimiento":
                    ...
                    if (r == true) {
                        ...
                        window.location.href = "../requerimientos/nuevo-requerimiento";
                    } else {
