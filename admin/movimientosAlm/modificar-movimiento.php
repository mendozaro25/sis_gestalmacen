<?php
    ...
    GROUP BY d.idMovAlmacen, m.fechaMov, m.estadoMov, m.tipoMov, m.Movimiento, m.tipoDoc, m.numDoc, m.nombreRazon, m.observacionMov, m.pecosa, m.pdf";
        ...
        <section>
                ...
                <div class="sidebar-left-info">                    
                    ...
                    <ul class="side-navigation">
                        ...
                        <li class="menu-list nav-active active"><a href=""><i class="mdi mdi-code-equal"></i> <span>Mov. Almacén</span></a>
                            <ul class="child-list">
                                <li class="active"><a href="../movimientosAlm/nuevo-movimiento"> Registrar Mov. Almacén</a></li>
            ...
            <div class="body-content">
                ...
                <div class="container-fluid">
                    <form onsubmit="return confirm('¿Realmente deseas modificar el movimiento?');" action="../actions/movimientoAlm/update.php" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4">                                                    
                                                        ...
                                                        <a type="button" class="tabledit-edit-button btn btn-sm btn-danger" target="_blank"
                                                            href="pdf/<?php echo $rowdetalle['pdf'];?>">
...
<form onsubmit="return confirm('Este movimiento sera eliminado. ¿Aceptar?');" action="../actions/movimientoAlm/delete.php" method="post">
    <!-- Modal -->
    <?php
        //Sesion
        include("../config/user-session.php");
