        ...
        <section>
                    ...
                    <ul class="side-navigation">
                        ...
                        <li class="menu-list nav-active active"><a href=""><i class="mdi mdi-worker"></i> <span>Cargos</span></a>
                            <ul class="child-list">
                                ...
                                <li class="active"><a href="../cargos/lista-cargo"> Lista de cargos</a></li>
                            </ul>
                        </li>                       
                    </ul><!--sidebar nav end-->
                </div>
            ...
            <div class="body-content">
                ...
                <div class="container-fluid">
                    <div class="page-head">
                        <h4 class="my-2">Lista de Cargos
                            <a style="margin-bottom: 4px;" class="btn btn-sm btn-danger" href="../cargos/nuevo-cargo">
                                <i class="ti-plus"></i>
                            </a>
                        </h4>
                    </div>                   
                                        ...
                                        <div class="table-odd">
                                            <table id="datatable" class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <a type="button" class="tabledit-edit-button btn btn-sm btn-info" href="./modificar-cargo?idCargo=<?php echo $row['idCargo'];?>">
                                                                <span class="ti-pencil" style="color: white;"></span>
                                                            </a>
                                                            <a type="button" onclick="return confirmDelete();" class="tabledit-delete-button btn btn-sm btn-danger" href="../actions/cargo/delete.php?idCargo=<?php echo $row['idCargo'];?>">
