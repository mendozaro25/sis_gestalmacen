<?php
    ...
    //Cargo a modificar
    $id=$_GET['idCargo'];
    $sqlCar="SELECT * FROM cargo WHERE idCargo = '$id'";
    $datosCar=mysqli_query($con,$sqlCar) or die ('Error en el query database');
?>
<!DOCTYPE html>
<html lang="es">
    <head>
        ...
        <section>
            ...
            <div class="sidebar-left">
                <div class="sidebar-left-info">                    
                    ...
                    <ul class="side-navigation">
                        ...
                        <li class="menu-list nav-active active"><a href=""><i class="mdi mdi-worker"></i> <span>Cargos</span></a>
                            <ul class="child-list">
                                <li class="active"><a href="../cargos/nuevo-cargo"> Registrar cargos</a></li>
            ...
            <div class="body-content">
                ...
                <div class="container-fluid">
                    <div class="page-head">
                        <h4 class="my-2">Nuevo Cargo
                            <a style="margin-bottom: 4px;" class="btn btn-sm btn-danger" href="../cargos/lista-cargo">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <form action="../actions/cargo/update.php" method="post">
                                        <?php  while ($row = $datosCar->fetch_assoc()) { ?>
                                        <div class="form-group">                                            
                                            <div class="col-lg-1">
                                                <input class="form-control" readonly="readonly" name="id" type="hidden" value="<?php echo $row['idCargo'];?>"/>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <label>Nombre del Cargo</label>
                                                    <input type="text" class="form-control" name="nombre" value="<?php echo $row['nombreCargo'];?>"/>
                                                </div>
                                                <div class="col-lg-6">                                                 
                                                    <label>Estado del Cargo</label>
                                                    <select class="form-control" name="estado">
                                                        <option value="<?php echo $row['estadoCargo'];?>" selected hidden>
                                                        <?php
                                                            if($row['estadoCargo']=='1'){
                                                                ?>
                                        ...
                                        <div class="form-group mb-0">
                                            <div>
                                                ...
                                                <button type="submit" class="btn btn-primary waves-effect waves-light">
                                                    <a style="color:white;" href="./lista-cargo">Volver</a>
                                                </button>
                                            </div>
                                        </div>
                                    </form>
