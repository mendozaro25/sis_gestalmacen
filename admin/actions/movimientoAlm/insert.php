<?php
    ...
    $resultadoMov=mysqli_query($con,$sql) or die ('Error en el query database');
    ...
    for ($i=0; $i<$count; $i++ ) {
        ...
        $resultadoDetalleMov=mysqli_query($con,$sqlDetalleMov) or die ('Error en el query database');
        ...
        $resultadoStockIngreso=mysqli_query($con,$sqlStockIngreso) or die ('Error en el query database');
    }

    //Cerramos Conexión
        mysqli_close($con);
    //Rediccionar
    $nuevaURL = '../../movimientosAlm/nuevo-movimiento';
