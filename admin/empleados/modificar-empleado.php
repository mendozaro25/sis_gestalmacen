                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <form action="../actions/empleado/update.php" method="post">
                                        <?php  while ($row = $datosEmp->fetch_assoc()) { ?>
                                        <div class="form-group">                                            
                                            <div class="col-lg-1">
                                                <input class="form-control" readonly="readonly" name="id" type="hidden" value="<?php echo $row['idEmpleado'];?>"/>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <label>Nombres</label>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">                                                    
                                                    ...
                                                    <select class="form-control" name="area">
                                                        <option value=" <?php echo $row['idArea'];?> " selected hidden><?php echo $row['nombreArea'];?></option>
                                                ...
                                                <div class="col-lg-6">                                                    
                                                    ...
                                                    <select class="form-control" name="cargo">
                                                        <option value=" <?php echo $row['idCargo'];?> " selected hidden><?php echo $row['nombreCargo'];?></option>                                                                                                          
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-4">                                                    
                                                    ...
                                                    <input type="text" class="form-control" maxlength="9" name="telefono" value="<?php echo $row['telefono'];?>"/>
                                                </div>
                                                <div class="col-lg-4">                                                    
                                                    <label>Dni</label>
                                                    <input type="text" class="form-control" maxlength="8" name="dni" value="<?php echo $row['dni'];?>"/>
                                                </div>  
                                                <div class="col-lg-4">                                                    
                                                    <label>Email</label>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">                                                    
                                                    ...
                                                    <select class="form-control" name="estado">
                                                        <option value="<?php echo $row['estadoEmpleado'];?>" selected hidden>
                                                        <?php
                                        ...
                                        <div class="form-group mb-0">
                                            <div>
                                                ...
                                                <button type="submit" class="btn btn-primary waves-effect waves-light">
                                                    <a style="color:white;" href="./lista-empleado">Volver</a>
                                                </button>
                                            </div>
                                        </div>
                                    </form>
