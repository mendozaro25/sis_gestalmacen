        ...
        <section>
                    ...
                    <ul class="side-navigation">
                        ...
                        <li class="menu-list nav-active active"><a href=""><i class="mdi mdi-account-circle"></i> <span>Empleados</span></a>
                            <ul class="child-list">
                                ...
                                <li class="active"><a href="../empleados/lista-empleado"> Lista de empleados</a></li>
                            </ul>
                        </li>    
            ...
            <div class="body-content">
                ...
                <div class="container-fluid">
                    <div class="page-head">
                        <h4 class="my-2">Lista de Empleados
                            <a style="margin-bottom: 4px;" class="btn btn-sm btn-danger" href="../empleados/nuevo-empleado">
                                <i class="ti-plus"></i>
                            </a>
                        </h4>
                    </div>                   
                                        ...
                                        <div class="table-odd">
                                            <table id="datatable" class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <a type="button" class="tabledit-edit-button btn btn-sm btn-info" href="./modificar-empleado?idEmpleado=<?php echo $row['idEmpleado'];?>">
                                                                <span class="ti-pencil" style="color: white;"></span>
                                                            </a>
                                                            <a type="button" onclick="return confirmDelete();" class="tabledit-delete-button btn btn-sm btn-danger" href="../actions/empleado/delete.php?idEmpleado=<?php echo $row['idEmpleado'];?>">
