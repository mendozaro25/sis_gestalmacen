                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <form action="../actions/usuario/insert.php" method="post">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-6">                                                    
                                                    <label>Empleado</label>
                                                    <select class="js-empleado form-control" name="empleado" required>
                                                        <option selected disabled hidden>- Seleccionar -</option>                                                                                                            
                                                        <?php  while ($row = $datosEmp->fetch_assoc()) {?>
                                                            <option value="<?php echo $row['idEmpleado'];?>"><?php echo $row['nombres'].' '.$row['apellidos']; ?></option>                                                                                                           
                                                        <?php }?>
                                                    </select>
                                                </div>
                                                <div class="col-lg-6">                                                    
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-4">                                                    
                                                    <label>Usuario</label>
                                                    <input type="text" class="form-control" name="usuario" required autofocus placeholder="usuario123"/>
                                                </div>
                                                <div class="col-lg-4">                                                    
                                                    <label>Clave</label>
                                        ...
                                        <div class="form-group mb-0">
                                            <div>
                                                ...
                                                <button type="submit" class="btn btn-primary waves-effect waves-light">
                                                    <a style="color:white;" href="./lista-usuario">Cancelar</a>
                                                </button>
                                            </div>
                                        </div>
                                    </form>
