        ...
        <section>
                    ...
                    <ul class="side-navigation">
                        ...
                        <li class="menu-list nav-active active"><a href=""><i class="mdi mdi-account-plus"></i> <span>Usuarios</span></a>
                            <ul class="child-list">
                                ...
                                <li class="active"><a href="../usuarios/lista-usuario"> Lista de usuarios</a></li>
                            </ul>
                        </li>   
                        <li>
            ...
            <div class="body-content">
                ...
                <div class="container-fluid">
                    <div class="page-head">
                        <h4 class="my-2">Lista de Usuarios
                            <a style="margin-bottom: 4px;" class="btn btn-sm btn-danger" href="../usuarios/nuevo-usuario">
                                <i class="ti-plus"></i>
                            </a>
                        </h4>
                    </div>                   
                                        ...
                                        <div class="table-odd">
                                            <table id="datatable" class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <a type="button" class="tabledit-edit-button btn btn-sm btn-info" href="./modificar-usuario?idUsuario=<?php echo $row['idUsuario'];?>">
                                                                <span class="ti-pencil" style="color: white;"></span>
                                                            </a>
                                                            <a type="button" onclick="return confirmDelete();" class="tabledit-delete-button btn btn-sm btn-danger" href="../actions/usuario/delete.php?idUsuario=<?php echo $row['idUsuario'];?>">
