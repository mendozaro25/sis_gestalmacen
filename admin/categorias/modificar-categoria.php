<?php
    ...
    $id=$_GET['idCategoria'];
    $sqlCat="SELECT * FROM categoria WHERE idCategoria = '$id'";
        ...
        <section>
            ...
            <div class="sidebar-left">
                <div class="sidebar-left-info">                    
                    ...
                    <ul class="side-navigation">
                        ...
                        <li class="menu-list nav-active active"><a href=""><i class="mdi mdi-slack"></i> <span>Categorias</span></a>
                            <ul class="child-list">
                                <li class="active"><a href="../categorias/nuevo-categoria"> Registrar categorias</a></li>
            ...
            <div class="body-content">
                ...
                <div class="container-fluid">
                    <div class="page-head">
                        <h4 class="my-2">Nuevo Categoria
                            <a style="margin-bottom: 4px;" class="btn btn-sm btn-danger" href="../categorias/lista-categoria">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <form action="../actions/categoria/update.php" method="post">
                                        <?php  while ($row = $datosCat->fetch_assoc()) { ?>
                                        <div class="form-group">                                            
                                            <div class="col-lg-1">
                                                <input class="form-control" readonly="readonly" name="id" type="hidden" value="<?php echo $row['idCategoria'];?>"/>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <label>Nombre de la Categoria</label>
                                                    <input type="text" class="form-control" name="nombre" value="<?php echo $row['nombreCategoria'];?>"/>
                                                </div>
                                                <div class="col-lg-6">                                                 
                                                    <label>Estado de la Categoria</label>
                                                    <select class="form-control" name="estado">
                                                        <option value="<?php echo $row['estadoCategoria'];?>" selected hidden>
                                                        <?php
                                        ...
                                        <div class="form-group mb-0">
                                            <div>
                                                ...
                                                <button type="submit" class="btn btn-primary waves-effect waves-light">
                                                    <a style="color:white;" href="./lista-categoria">Volver</a>
                                                </button>
                                            </div>
                                        </div>
                                    </form>
