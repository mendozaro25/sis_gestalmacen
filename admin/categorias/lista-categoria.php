        ...
        <section>
                    ...
                    <ul class="side-navigation">
                        ...
                        <li class="menu-list nav-active active"><a href=""><i class="mdi mdi-slack"></i> <span>Categorias</span></a>
                            <ul class="child-list">
                                ...
                                <li class="active"><a href="../categorias/lista-categoria"> Lista de categorias</a></li>
                            </ul>
                        </li> 
            ...
            <div class="body-content">
                ...
                <div class="container-fluid">
                    <div class="page-head">
                        <h4 class="my-2">Lista de Categorias
                            <a style="margin-bottom: 4px;" class="btn btn-sm btn-danger" href="../categorias/nuevo-categoria">
                                <i class="ti-plus"></i>
                            </a>
                        </h4>
                    </div>                   
                                        ...
                                        <div class="table-odd">
                                            <table id="datatable" class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <a type="button" class="tabledit-edit-button btn btn-sm btn-info" href="./modificar-categoria?idCategoria=<?php echo $row['idCategoria'];?>">
                                                                <span class="ti-pencil" style="color: white;"></span>
                                                            </a>
                                                            <a type="button" onclick="return confirmDelete();" class="tabledit-delete-button btn btn-sm btn-danger" href="../actions/categoria/delete.php?idCategoria=<?php echo $row['idCategoria'];?>">
