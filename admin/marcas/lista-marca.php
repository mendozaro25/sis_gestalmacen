        ...
        <section>
                    ...
                    <ul class="side-navigation">
                        ...
                        <li class="menu-list nav-active active"><a href=""><i class="mdi mdi-credit-card-scan"></i> <span>Marcas</span></a>
                            <ul class="child-list">
                                ...
                                <li class="active"><a href="../marcas/lista-marca"> Lista de marcas</a></li>
                            </ul>
                        </li> 
            ...
            <div class="body-content">
                ...
                <div class="container-fluid">
                    <div class="page-head">
                        <h4 class="my-2">Lista de Marcas
                            <a style="margin-bottom: 4px;" class="btn btn-sm btn-danger" href="../marcas/nuevo-marca">
                                <i class="ti-plus"></i>
                            </a>
                        </h4>
                    </div>                   
                                        ...
                                        <div class="table-odd">
                                            <table id="datatable" class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <a type="button" class="tabledit-edit-button btn btn-sm btn-info" href="./modificar-marca?idMarca=<?php echo $row['idMarca'];?>">
                                                                <span class="ti-pencil" style="color: white;"></span>
                                                            </a>
                                                            <a type="button" onclick="return confirmDelete();" class="tabledit-delete-button btn btn-sm btn-danger" href="../actions/marca/delete.php?idMarca=<?php echo $row['idMarca'];?>">
