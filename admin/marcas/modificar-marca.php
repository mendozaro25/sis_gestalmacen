<?php
    ...
    //Marca a modificar
    $id=$_GET['idMarca'];
    $sqlMar="SELECT * FROM marca WHERE idMarca = '$id'";
        ...
        <section>
            ...
            <div class="sidebar-left">
                <div class="sidebar-left-info">                    
                    ...
                    <ul class="side-navigation">
                        ...
                        <li class="menu-list nav-active active"><a href=""><i class="mdi mdi-credit-card-scan"></i> <span>Marcas</span></a>
                            <ul class="child-list">
                                <li class="active"><a href="../marcas/nuevo-marca"> Registrar marcas</a></li>
            ...
            <div class="body-content">
                ...
                <div class="container-fluid">
                    <div class="page-head">
                        <h4 class="my-2">Nuevo Marca
                            <a style="margin-bottom: 4px;" class="btn btn-sm btn-danger" href="../marcas/lista-marca">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <form action="../actions/marca/update.php" method="post">
                                        <?php  while ($row = $datosMar->fetch_assoc()) { ?>
                                        <div class="form-group">                                            
                                            <div class="col-lg-1">
                                                <input class="form-control" readonly="readonly" name="id" type="hidden" value="<?php echo $row['idMarca'];?>"/>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <label>Nombre de la Marca</label>
                                                    <input type="text" class="form-control" name="nombre" value="<?php echo $row['nombreMarca'];?>"/>
                                                </div>
                                                <div class="col-lg-6">                                                 
                                                    <label>Estado de la Marca</label>
                                                    <select class="form-control" name="estado">
                                                        <option value="<?php echo $row['estadoMarca'];?>" selected hidden>
                                                        <?php
                                        ...
                                        <div class="form-group mb-0">
                                            <div>
                                                ...
                                                <button type="submit" class="btn btn-primary waves-effect waves-light">
                                                    <a style="color:white;" href="./lista-marca">Volver</a>
                                                </button>
                                            </div>
                                        </div>
                                    </form>
