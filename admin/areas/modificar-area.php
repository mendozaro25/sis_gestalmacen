<?php
    ...
    $id=$_GET['idArea'];
    $sqlAre="SELECT * FROM area WHERE idArea = '$id'";
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <form action="../actions/area/update.php" method="post">
                                        <?php  while ($row = $datosAre->fetch_assoc()) { ?>
                                        <div class="form-group">                                            
                                            <div class="col-lg-1">
                                                <input class="form-control" readonly="readonly" name="id" type="hidden" value="<?php echo $row['idArea'];?>"/>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <label>Nombre de la Área</label>
                                                    <input type="text" class="form-control" name="nombre" value="<?php echo $row['nombreArea'];?>"/>
                                                </div>
                                                <div class="col-lg-6">                                                 
                                                    <label>Estado de la Área</label>
                                                    <select class="form-control" name="estado">
                                                        <option value="<?php echo $row['estadoArea'];?>" selected hidden>
                                                        <?php
                                                            if($row['estadoArea']=='1'){
                                                                ?>
                                        ...
                                        <div class="form-group mb-0">
                                            <div>
                                                ...
                                                <button type="submit" class="btn btn-primary waves-effect waves-light">
                                                    <a style="color:white;" href="./lista-area">Volver</a>
                                                </button>
                                            </div>
                                        </div>
                                    </form>
