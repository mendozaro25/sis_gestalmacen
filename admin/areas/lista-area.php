<?php
    ...
    //Areas
    $sqlAre="SELECT * FROM area";
    $datosAre=mysqli_query($con,$sqlAre) or die ('Error en el query database');
?>
<!DOCTYPE html>
<html lang="es">
    <head>
        ...
        <section>
                    ...
                    <ul class="side-navigation">
                        ...
                        <li class="menu-list nav-active active"><a href=""><i class="mdi mdi-wallet-membership"></i> <span>Areas</span></a>
                            <ul class="child-list">
                                ...
                                <li class="active"><a href="../areas/lista-area"> Lista de areas</a></li>
                            </ul>
                        </li> 
            ...
            <div class="body-content">
                ...
                <div class="container-fluid">
                    <div class="page-head">
                        <h4 class="my-2">Lista de Areas
                            <a style="margin-bottom: 4px;" class="btn btn-sm btn-danger" href="../areas/nuevo-area">
                                <i class="ti-plus"></i>
                            </a>
                        </h4>
                    </div>                   
                                    ...
                                    <div class="card-body table-responsive">
                                        <div class="table-odd">
                                            <table id="datatable" class="table table-bordered">
                                                ...
                                                <tbody>
                                                <?php  while ($row = $datosAre->fetch_assoc()) {?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <a type="button" class="tabledit-edit-button btn btn-sm btn-info" href="./modificar-area?idArea=<?php echo $row['idArea'];?>">
                                                                <span class="ti-pencil" style="color: white;"></span>
                                                            </a>
                                                            <a type="button" onclick="return confirmDelete();" class="tabledit-delete-button btn btn-sm btn-danger" href="../actions/area/delete.php?idArea=<?php echo $row['idArea'];?>">
