                ...
                <div class="sidebar-left-info">
                    ...
                    <div class="user-box">
                        ...
                        <?php  while ($rowFoto = $datosFoto->fetch_assoc()) { ?>
                            <img src="photo/<?php echo $rowFoto['foto'];?>" alt="user_foto" class="img-fluid rounded-circle"> 
                        <?php } ?>
                        </div>
                ...
                <div class="container-fluid">
                    <form action="profile-update.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <img id="preview_image" src="photo/<?php echo $rowUsu['foto'];?>" alt="avatar_user" class="rounded-circle mx-auto d-block">
                                                </div>
                                                <div class="col-lg-6">
                                                    <label>Actualizar Foto</label>
                                                    <input name="photo" id="photo-upload" onchange="readURL(this);" accept=".png, .jpg, .jpeg, .gif" class="form-control" type="file" title="Cambiar foto"/>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="form-group">
                                    ...
                                    <div class="card-body">                                        
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <label>Dni</label>
                                                    <input class="form-control" type="text" maxlength="8" name="dni" value="<?php echo $rowUsu['dni'];?>"/>
                                                </div>
                                                <div class="col-lg-4">
                                                    <label>Telefono</label>
                                                    <input class="form-control" type="text" maxlength="9" name="telefono" value="<?php echo $rowUsu['telefono'];?>"/>
                                                </div>
                                                <div class="col-lg-4">
                                                    <label>Email</label>
                        ...
                        <div class="form-group mb-0">
                            <div>
                                <button type="submit" onclick="return confirmUpdate();" class="btn btn-danger waves-effect waves-light" name="submit">
                                    Guardar
                                </button>
...
<script>
    function readURL(input){
        ...
        if (input.files && input.files[0]) {
            // Convertir la imagen aael dataURL y guardar el resultado en url
