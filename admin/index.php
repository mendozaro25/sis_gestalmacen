...
//Acceso Denegado
include("config/access-denied-index.php");
//Usuarios Recientes
...
LIMIT 5";
$datosUsu=mysqli_query($con,$sqlUsu) or die ('Error en el query database1 ');
//Usuario-Foto
$sqlFoto="SELECT u.foto as foto FROM usuario u    
WHERE u.idUsuario = '$usuarioSes' AND u.estadoUsuario = 1";
$datosFoto=mysqli_query($con,$sqlFoto) or die ('Error en el query database 2');
//Productos Recientes
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-3">
                                   <div class="widget-box bg-white m-b-30">
                                        ...
                                        <a style="color: black;" href="movimientosAlm/lista-movimiento">
                                ...
                                <div class="col-lg-3 col-sm-3">
                                   <div class="widget-box bg-white m-b-30">
                                        ...
                                        <a style="color: black;" href="requerimientos/lista-requerimiento">
                                            <div class="row d-flex align-items-center text-center">
                                                <div class="col-4">
                                ...
                                <div class="col-lg-3 col-sm-3">
                                    <div class="widget-box bg-white m-b-30">
                                        ...
                                        <a style="color: black;" href="productos/lista-producto">
                                            <div class="row d-flex align-items-center text-center">
                                                <div class="col-4">
                                ...
                                <div class="col-lg-3 col-sm-3">
                                    <div class="widget-box bg-white m-b-30">
                                        ...
                                        <a style="color: black;" href="usuarios/lista-usuario">
                                            <div class="row d-flex align-items-center text-center">
                                                <div class="col-4">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover m-b-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div>
                                                                <a type="button" class="btn btn-sm btn-danger" href="requerimientos/modificar-requerimiento?idRequerimiento=<?php echo $rowReq_['idRequerimiento'];?>">
